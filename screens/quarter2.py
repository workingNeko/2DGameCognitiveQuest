...
class Quarter2:
    def __init__(self, screen, main_menu, map_name):
        ...
        # Distinct Filipino Character NPCs for Stations 1 to 5 (Generalized for dynamic DB questions)
        if self.map_name == "map5.txt":
            self.station_npc_info = {
                1: {
                    "name": "Station 1",
                    "title": "Station 1: Bamboo Post Builder",
                    "dialog_title": "Bahay Kubo Bamboo Posts Challenge",
                    "wrong_encouragement": "Bamboo Stilts - Try Again",
                    "correct_praise": "Bamboo Posts Erected! - Well Done",
                    "target_math": "Building Bamboo Foundation Posts",
                    "frames": [],
                    "anim_frame": 0,
                    "anim_timer": 0
                },
                2: {
                    "name": "Station 2",
                    "title": "Station 2: Sawali Wall Weaver",
                    "dialog_title": "Bahay Kubo Woven Walls Challenge",
                    "wrong_encouragement": "Woven Sawali - Try Again",
                    "correct_praise": "Sawali Walls Assembled! - Well Done",
                    "target_math": "Weaving Traditional Sawali Bamboo Walls",
                    "frames": [],
                    "anim_frame": 0,
                    "anim_timer": 0
                },
                3: {
                    "name": "Station 3",
                    "title": "Station 3: Window & Door Maker",
                    "dialog_title": "Bahay Kubo Windows & Door Challenge",
                    "wrong_encouragement": "Window Frames - Try Again",
                    "correct_praise": "Windows & Door Fitted! - Well Done",
                    "target_math": "Crafting Wooden Windows and Main Door",
                    "frames": [],
                    "anim_frame": 0,
                    "anim_timer": 0
                },
                4: {
                    "name": "Station 4",
                    "title": "Station 4: Thatched Nipa Weaver",
                    "dialog_title": "Bahay Kubo Thatched Roof Challenge",
                    "wrong_encouragement": "Nipa Roof - Try Again",
                    "correct_praise": "Nipa Roof Complete! - Well Done",
                    "target_math": "Thatching the Sloped Nipa Palm Roof",
                    "frames": [],
                    "anim_frame": 0,
                    "anim_timer": 0
                },
                5: {
                    "name": "Station 5",
                    "title": "Station 5: Wooden Ladder Craftsman",
                    "dialog_title": "Bahay Kubo Wooden Ladder Challenge",
                    "wrong_encouragement": "Ladder Steps - Try Again",
                    "correct_praise": "Bahay Kubo Completed! - Well Done",
                    "target_math": "Constructing the Entrance Bamboo Ladder",
                    "frames": [],
                    "anim_frame": 0,
                    "anim_timer": 0
                }
            ...
            self.station_npc_info = {
                1: {
                    "name": "Station 1",
                    "title": "Station 1: Aling Nena (Sari-Sari Store)",
                    "dialog_title": "Sari-Sari Store Challenge",
                    "wrong_encouragement": "Sari-Sari Store - Try Again",
                    "correct_praise": "Salamat! Ang galing mo naman!",
                    "target_math": "Sari-Sari Store Shopping Challenge",
                    "frames": [],
                    "anim_frame": 0,
                    "anim_timer": 0
                },
                2: {
                    "name": "Station 2",
                    "title": "Station 2: Mang Pedring (Sorbetes Cart)",
                    "dialog_title": "Sorbetes Cart Challenge",
                    "wrong_encouragement": "Sorbetes Cart - Try Again",
                    "correct_praise": "Super! Scoop of Math Success!",
                    "target_math": "Delicious Sorbetes Challenge",
                    "frames": [],
                    "anim_frame": 0,
                    "anim_timer": 0
                },
                3: {
                    "name": "Station 3",
                    "title": "Station 3: Kuya Jomar (Jeepney Terminal)",
                    "dialog_title": "Jeepney Terminal Challenge",
                    "wrong_encouragement": "Jeepney Terminal - Try Again",
                    "correct_praise": "Ayos! Next Stop: Math Mastery!",
                    "target_math": "Jeepney Route & Fare Challenge",
                    "frames": [],
                    "anim_frame": 0,
                    "anim_timer": 0
                },
                4: {
                    "name": "Station 4",
                    "title": "Station 4: Ate Maria (Market Fruit Stand)",
                    "dialog_title": "Market Fruit Stand Challenge",
                    "wrong_encouragement": "Fruit Stand - Try Again",
                    "correct_praise": "Tumpak! Perfectly Balanced!",
                    "target_math": "Sweet Guimaras Mangoes Challenge",
                    "frames": [],
                    "anim_frame": 0,
                    "anim_timer": 0
                },
                5: {
                    "name": "Station 5",
                    "title": "Station 5: Mang Carding (Parol Workshop)",
                    "dialog_title": "Fiesta Parol Workshop Challenge",
                    "wrong_encouragement": "Parol Workshop - Try Again",
                    "correct_praise": "Mabuhay! Lanterns Shine Bright!",
                    "target_math": "Festive Bamboo Parol Challenge",
                    "frames": [],
                    "anim_frame": 0,
                    "anim_timer": 0
                }
    ...
    def load_puzzle_sounds(self):
        try:
            ...
            if getattr(self, 'sorbetes_bell', None) and getattr(self, 'coin_clink', None) and getattr(self, 'snap_sound', None):
    ...
    def restart_level(self):
        """Restarts the current Quarter 2 level."""
        from screens.quarter2 import Quarter2
        self.main_menu.quarter2 = Quarter2(self.screen, self.main_menu, self.map_name)
